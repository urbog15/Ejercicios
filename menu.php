...
<a id="menusolicitudes" class="list-group-item" href="#"><i class="fa fa-file-o fa-2x"></i> Solicitudes</a>

<a id="subvacaciones" class="submenu list-group-item" href="<?=URLBASE;?>contenido/vacaciones.php"><i class="fa fa-sun-o fa-2x"></i> Vacaciones</a>
